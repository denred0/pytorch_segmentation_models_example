...
def inference(data_file, classes_file, weights_dir):
    ...
    pred_save_dir = Path(data_dict['prediction_test_dir'])
    ...
    output_dir_images = pred_save_dir.joinpath('test').joinpath('images')
    ...
    output_dir_masks = pred_save_dir.joinpath('test').joinpath('masks')
    ...
    output_dir_masks_rgb = pred_save_dir.joinpath('test').joinpath('masks_rgb')
    ...
    output_dir_vis = pred_save_dir.joinpath('test').joinpath('visualization')
    ...
    x_test_dir = data_dict['test_dir']
    y_test_dir = data_dict['testannot_dir']
